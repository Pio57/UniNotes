    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide " data-bs-ride="carousel">
        <div class="carousel-inner  " >
            <div class="carousel-item active" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block" style="border-radius: 20px; background: #cac8c8">

                    <h2><strong>SCOPRI TUTTI I CORSI CON IL RELATIVO MATERIALE!!</strong></h2>
                    <p></p>
                    <p><a class="btn btn-lg btn-primary" href="/UniNotes_war_exploded/Corso/visualizzaTuttiUtente"><strong>VAI</strong></a></p>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="../img/prefe.jpg" class="d-block w-80" alt="...">
                <div class="carousel-caption d-none d-md-block" style="border-radius: 20px; background: #cac8c8">
                    <h2><strong>AGGIUNGI I CORSI CHE PREFERISCI ALLA TUA FAVORITE LIST!!</strong></h2>
                    <p></p>
                    <p><a class="btn btn-lg btn-primary" href="/UniNotes_war_exploded/ListaPreferiti/visualizza"><strong>VAI</strong></a></p>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="../img/5272.png" class="d-block w-80" alt="...">
                <div class="carousel-caption d-none d-md-block" style="border-radius: 20px; background: #cac8c8">
                    <h2><strong>MANTIENI AGGIORNATO IL TUO LIBRETTO CON TUTTI I TUOI ESAMI!!</strong></h2>
                    <p></p>
                    <p><a class="btn btn-lg btn-primary" href="/UniNotes_war_exploded/Libretto/visualizzaLibretto"><strong>VAI</strong></a></p>
                </div>
        </div>
    ...
    <div class="container marketing text-black">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <p class="lead text-muted">UniNotes ti permette di condividere i tuoi appunti con tutti gli utenti iscritti!</p>
            </div>
            <div class="col-md-5">
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                ...
                <p class="lead text-muted ">UniNotes ti permette di scaricare il materiale inserito da altri utenti!</p>
            </div>
